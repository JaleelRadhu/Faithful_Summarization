...
run: 
	...
	@for file in $(INPUT_FILES); do \
		...
		$(PYTHON_ENV) $(PROJECT_ROOT)/main_new.py --input_data $(DATA_DIR)/$$file --is_evaluator_and_improver_same False --general_eval_and_improver False || echo "[WARN] Failed to process $$file. Continuing..."; \
	done
